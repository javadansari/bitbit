...
public class SqlCategory extends SugarRecord {


    private String ii;
    private String parent;
    private String company;
    private String galleryCollectionStatus;
    private String galleryCollectionType;
    private String url;
    ...
    public SqlCategory(String ii, String parent, String company, String galleryCollectionStatus, String galleryCollectionType, String url, String title, String comment, String sort, String datetimeCreate, String titleGalleryCollectionStatus, String titleGalleryCollectionType, String level, String entGalleryCollectionCategory, String entGalleryItem) {
        this.ii = ii;
        this.parent = parent;
    ...
    public String getGalleryCollectionStatus() {
        return galleryCollectionStatus;
    }

    public void setGalleryCollectionStatus(String galleryCollectionStatus) {
        this.galleryCollectionStatus = galleryCollectionStatus;
    }

    public String getGalleryCollectionType() {
        return galleryCollectionType;
    }

    public void setGalleryCollectionType(String galleryCollectionType) {
        this.galleryCollectionType = galleryCollectionType;
    }
